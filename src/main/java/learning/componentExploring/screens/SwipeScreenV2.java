...
import learning.componentExploring.components.CarouselComponent;
...
public class SwipeScreenV2 extends BaseScreenV2 {
...
//  private WebElement
  ...
  public SwipeScreenV2(AppiumDriver driver) {
...
//        SwipeHorizontal swipeHorizontal = new SwipeHorizontal(driver, carouselContainerEl());
  ...
  public SwipeScreenV2 swipeLeft(int maxSwipes) {
  ...
  public SwipeScreenV2 swipeRight(int maxSwipes) {
    SwipeHorizontally swipeHorizontal = new SwipeHorizontally(driver, this.carouselComponent.getCarouselEl());
